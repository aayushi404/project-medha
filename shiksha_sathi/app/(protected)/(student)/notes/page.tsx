  ...
  return (
    <main className="flex flex-1 flex-col overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <h1 className="text-[15px]">Notes</h1>
        <p className="mt-0.5 text-xs text-muted-foreground">
          Short, revision-ready notes for every chapter.
        </p>
      </div>
        ...
        {!subjectId ? (
          <div className="flex flex-1 flex-col items-center justify-center gap-2 px-4 py-20 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Pick a subject to browse chapter notes.
            </p>
          </div>
        ) : (
            ...
            {!chapterPicked ? (
              ...
              <article className="flex flex-col gap-5">
                <header className="flex items-start justify-between gap-3">
                  <div>
                    <h2 className="text-lg font-medium">{chapterTitle}</h2>
              ...
              <div className="flex flex-col items-center gap-3 rounded-xl bg-card p-8 text-center ring-1 ring-foreground/10">
                ...
                <p className="text-sm font-medium">Notes for “{chapterTitle}” are being prepared</p>
                <p className="max-w-sm text-xs text-muted-foreground">
                  Each chapter will have a short summary, key points, explained
                  sections and a list of important terms — like the notes already
                  available for Photosynthesis, Friction and Force &amp; Pressure.
                </p>
              </div>
            )}
          </div>
